...
export default function CreateRequest({ theme }) {
  ...
  function handleSubmit(event) {
    createRequest(issue, description, location, branch, category, subCategory, type);
  }
  ...
  return (
    ...
    <ThemeProvider theme={theme}>
      <Container maxWidth='sm' sx={{ p: 2 }}>
        <Box component='form' onSubmit={(e) => { e.preventDefault(); setOpen(true); }}>
          <Typography
            sx={{
              textAlign: 'center',
              userSelect: 'none'
          ...
          <Divbox comp={<TextField multiline fullWidth
